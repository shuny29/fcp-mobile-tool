...
const AUTO_MIN_SILENCE_MS = 700; // これより長く声が途切れたら無音区間として扱う(短い間は残す)
const AUTO_PADDING_MS = 250;     // 発話の前後に残す余白(語尾の余韻を残すため多めに)
...
const SPEECH_PERCENTILE = 0.60;  // 「発話」の目安として使う音量分布の上側パーセンタイル。
                                  ...
                                  // やや低めにしてある。
const THRESHOLD_MIX = 0.25;      // 暗騒音〜発話の間のどこにしきい値を置くか(0=暗騒音寄り,1=発話寄り)。
                                  // 保守的にしすぎるとほとんどカットされなくなるため、
                                  // 実データを見ながらやや発話寄りに調整している。
